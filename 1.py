...
def lisensi():
    ...
    r = requests.get('https://zhulantos.000webhostapp.com/mauapalo/password.txt').text
    if passw == '':
...
def pilih():
    ...
    if zedd == '':
        ...
        if zedd == '1':
            ...
            if zedd == '2':
                r = requests.get('https://zhulantos.000webhostapp.com/mauapalo/menuhack.txt').text
                if 'tutup' in r:
...
if __name__ == '__main__':
     r = requests.get('https://zhulantos.000webhostapp.com/mauapalo/lock.txt').text
     if 'tutup' in r:
